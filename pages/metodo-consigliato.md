...
Ma il cervello umano non parla calcolando equazioni in tempo reale. A scuola passavamo anni a studiare i verbi irregolari a memoria, ma spesso non eravamo nemmeno in grado di gestire i primi [saluti in inglese](https://nausica-c.github.io/FluenteMente/inglese/da-zero/salutari-in-inglese/) in modo fluido e naturale durante un viaggio. 
...
* **Rischio di incostanza:** Nessuno ti obbliga a fare i compiti. Per questo è vitale affiancare a questa strategia mentale la capacità pratica di [costruire una routine di studio solida](https://nausica-c.github.io/FluenteMente/routine/), studiando poco ma ogni giorno.
...
Il Principio di Pareto si applica perfettamente alle lingue: il 20% delle parole e delle strutture grammaticali ti permetterà di gestire l'80% delle conversazioni quotidiane. Invece di voler sapere tutto subito, punta al nucleo essenziale. Non ti serve il congiuntivo trapassato nei primi mesi; ti serve saper descrivere la tua [routine quotidiana](https://nausica-c.github.io/FluenteMente/inglese/vocabolario/a1/routine-quotidiana-descrivere-giornata/), ordinare un caffè e parlare del tuo lavoro in modo semplice.

### Pilastro 2: L'Input Comprensibile (Ascoltare per capire)
Il linguista Stephen Krashen ha dimostrato che impariamo le lingue in un solo modo: [comprendendo i messaggi](https://nausica-c.github.io/FluenteMente/input-comprensibile-krashen/). Questo si chiama *Comprehensible Input*. Se ascolti un telegiornale senza sapere una parola, è solo rumore bianco. Il tuo obiettivo è circondarti di podcast, testi e video che siano solo un gradino sopra il tuo livello attuale.

### Pilastro 3: La Ripetizione Spaziata (Memorizzare per sempre)
Leggere una parola una volta non serve a nulla. Il cervello cancella le informazioni non necessarie per risparmiare energia. Per ingannarlo, devi usare la [ripetizione spaziata](https://nausica-c.github.io/FluenteMente/ripetizione-spaziata-lingue/) (Spaced Repetition). Devi rivedere un vocabolo poco prima che il tuo cervello lo dimentichi: oggi, poi tra due giorni, poi tra una settimana, poi tra un mese. 
...
Quando parti da zero, ti serve una guida strutturata che ti introduca gradualmente ai suoni e alle strutture di base. 

In questa fase, **l'obiettivo non è parlare perfettamente, ma superare lo shock iniziale.** Affidati a un'app ben strutturata che integri automaticamente la ripetizione spaziata. Noi suggeriamo spesso un approccio guidato (puoi leggere la nostra [recensione di Babbel](https://nausica-c.github.io/FluenteMente/recensione-babbel/) per capire perché la preferiamo per costruire basi solide).

*Azione pratica:* Usa uno strumento guidato per 15-20 minuti al giorno. Se vuoi una sfida rapida, prova la nostra [sfida 10 giorni 50 parole](https://nausica-c.github.io/FluenteMente/inglese/da-zero/sfida-10-giorni-50-parole/). Puoi anche [iniziare gratis con la prima lezione di Babbel qui](https://www.awin1.com/awclick.php?gid=322314&mid=9659&awinaffid=2764918&linkid=2038224&clickref=).

### Fase 2: Il Consolidamento e l'Input (Mesi 4-8)
Una volta superato il livello A2, devi "oliare" gli ingranaggi attraverso il consumo massiccio di contenuti.

* Leggi articoli brevi su argomenti pratici (ad esempio, come [vivere la città](https://nausica-c.github.io/FluenteMente/inglese/vocabolario/a1/vivere-la-citta/) in lingua).
* Esplora le nostre [risorse e strumenti utili](https://nausica-c.github.io/FluenteMente/risorse/) per trovare materiali adatti al tuo livello.
...
Sei arrivato al fatidico livello intermedio (B1/B2). È il momento di forzare l'Output. Devi iniziare a produrre la lingua parlando da solo, tenendo un diario o cercando un *language partner* online.
...
1. **L'ossessione per la pronuncia perfetta:** L'obiettivo iniziale è la *comunicazione*, non la perfezione fonetica.
2. **Tradurre mentalmente dall'italiano:** Ti rende lento. Impara le parole all'interno del loro contesto.
3. **Il binge-studying del weekend:** Studiare tre ore la domenica e zero durante la settimana è il modo migliore per dimenticare tutto.
...
Abbandona l'idea di studiare liste infinite di vocaboli decontestualizzati. Punta sull'essenziale e circondati di contenuti che capisci. Se sei all'inizio e hai bisogno di strutturare le tue "Fondamenta" senza stress, la mossa più intelligente è appoggiarsi a un corso digitale. 
...
Per un'idea realistica basata sui dati, consulta la nostra guida sul [tempo di apprendimento tramite app](https://nausica-c.github.io/FluenteMente/tempo-apprendimento-app/). Generalmente, con 20 minuti al giorno, puoi raggiungere un livello di sopravvivenza in circa 6-8 mesi.

**Posso imparare una lingua guardando solo serie TV su Netflix?**
No, se sei un principiante assoluto. Le serie TV diventano utili dalla Fase 2 (Intermedio) in poi, come strumento di *Comprehensible Input*.

**La grammatica non va studiata affatto?**
Falso. La grammatica è fondamentale, ma deve seguire la pratica. Invece di partire dalla regola per arrivare alla frase, parti dalla frase utile e solo dopo vai a curiosare sul perché si usa un determinato tempo verbale. 

**Meglio imparare da autodidatta o con un insegnante?**
L'approccio autodidatta è perfetto ed economico per le prime due fasi. L'insegnante diventa prezioso nella Fase 3, per sbloccare la conversazione reale.
