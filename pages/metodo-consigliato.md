...
*Disclaimer: questo articolo contiene link affiliati a servizi che abbiamo testate e che riteniamo validi per applicare il metodo descritto. Acquistando tramite questi link, potremmo ricevere una piccola commissione senza costi aggiuntivi per te. Questo ci aiuta a mantenere FluenteMente gratuito.*
...
Ma il cervello umano non parla calcolando equazioni in tempo reale. A scuola passavamo anni a studiare i verbi irregolari a memoria, ma spesso non eravamo nemmeno in grado di gestire i primi [saluti in inglese](../inglese/da-zero/salutari-in-inglese/) in modo fluido e naturale durante un viaggio. 
...
Leggere una parola una volta non serve a nulla. Il cervello cancella le informazioni non necessarie per risparmiare energia. Per ingannarlo, devi usare la [ripetizione spaziata](../ripetizione-spaziata-lingue/) (Spaced Repetition). Devi rivedere un vocabolo poco prima che il tuo cervello lo dimentichi: oggi, poi tra due giorni, poi tra una settimana, poi tra un mese. Questo trasferisce le informazioni dalla memoria a breve termine a quella a lungo termine.
...
*Azione pratica:* Usa uno strumento guidato per 15-20 minuti al giorno per costruire un vocabolario di base. Puoi [iniziare gratis con la prima lezione di Babbel qui](https://www.awin1.com/awclick.php?gid=322314&mid=9659&awinaffid=2764918&linkid=2038224&clickref=).
...
* Leggi articoli brevi o blog su argomenti che ti appassionano (ad esempio, come [vivere la città](../inglese/vocabolario/a1/vivere-la-citta/) in lingua).
...
* **Conversazione reale:** Trova un *language partner* online o prenota lezioni di conversazione. Devi abituarti allo stress di pensare e formulare frasi in tempo reale.
...
1. **L'ossessione per la pronuncia perfetta:** Molti studenti si bloccano perché hanno paura del proprio accento. L'obiettivo iniziale è la *comunicazione*, non la perfezione fonetica.
...
Dipende dalla lingua scelta e dalla costanza. Per un'idea realistica, consulta la nostra guida sul [tempo di apprendimento tramite app](../tempo-apprendimento-app/). Generalmente, con 20 minuti al giorno, puoi raggiungere un livello discreto in 6-8 mesi.

**Posso imparare una lingua guardando solo serie TV su Netflix?**
No, se sei un principiante assoluto guardare Netflix è come ascoltare rumore. Le serie TV diventano utili dalla Fase 2 (Intermedio) in poi, quando puoi usare i sottotitoli nella lingua originale per fare *Comprehensible Input*.

**La grammatica non va studiata affatto?**
Falso. La grammatica è fondamentale, ma cambia il *momento* in cui la studi. Invece di partire dalla regola per arrivare alla frase, parti dalla frase utile (es. "I would like a coffee"), imparala a memoria, e solo dopo vai a curiosare sul perché si usa un determinato tempo verbale. 

**Meglio imparare da autodidatta o con un insegnante?**
L'approccio autodidatta è perfetto per le prime due fasi (acquisizione del vocabolario e ascolto). L'insegnante diventa prezioso nella Fase 3, per sbloccare la conversazione e correggere errori radicati.

**Sono troppo vecchio per imparare una nuova lingua?**
Assolutamente no. Gli adulti hanno un vantaggio enorme: sanno *come* imparare. Con il metodo giusto, la logica di un adulto può assimilare e dedurre le regole molto più velocemente di un bambino.
